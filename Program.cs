                     ...
                     if (question == "Exit")
            {
                ...
                else
                {
                    ...
                    // this is where we actually answer the question
                    {
                        ...
                        // take sentence with greatest value from []percentageSimilar 
                        // run getAnswer (based on a switch case of the determine factoid type)
                        // Print answer
                        // celebrate, because this IS FUCKING DOOOOOONE, LEEEETS GOOOOOOOO!
                    }
                }
            }
            while (endprogram == false) ;
